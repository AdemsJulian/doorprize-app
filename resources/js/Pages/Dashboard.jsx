...
export default function Dashboard(props) {
    ...
    const handleActiveClick = (result) => {
        router.post(route('draw.update.main', result))
    }
            ...
            <div>
                <div className="mx-auto sm:px-6 lg:px-8 ">
                    <div className="overflow-hidden shadow-sm sm:rounded-lg bg-white dark:bg-gray-800 w-full py-4">
                        ...
                        <img src="/logo-2.png" className="h-24 w-24 mx-auto" />
                    </div>
                    ...
                    <div className="overflow-auto mt-2 p-4 bg-gray-200 rounded-md">
                        <div className="w-full flex flex-row justify-between py-2">
                            <div className="flex items-center">
                                <h1 className='text-md text-black-700 uppercase'>Non Active Participants</h1>
                            </div>
                        </div>
                        <div>
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 mb-4">
                                ...
                                <tbody>
                                    {noActive.map((result) => (
                                        ...
                                        >
                                            ...
                                            <td className="py-4 px-6 underline text-blue-700">
                                                <div
                                                    onClick={() =>
                                                        handleActiveClick(
                                                            result
