...
export default function Button({
    ...
    const htmlButtonTypes = new Set(["button", "submit", "reset"]);

    let variant = type;
    let resolvedNativeType = nativeType;

    // Backward-compatible: if `type="submit"` is passed, treat it as HTML button type.
    if (htmlButtonTypes.has(type) && nativeType === "button") {
        resolvedNativeType = type;
        variant = "primary";
    }
